...
class Scraper(object):
    def __init__(self, category: str, date_from: str = None, date_until: str = None, t: int = 30, timeout: int = 300, filters: Dict[str, str] = {}, max_records: int = 1000):
        ...
        while len(ds) < self.max_records:
            try:
                ...
                for record in records:
                    ...
                    if self.append_all or any(word.lower() in rec[key] for key in self.keys for word in self.filters[key]):
                        ds.append(rec)
